    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <div className="inline-block bg-[#EFE7F9] text-[#6A2E9A] text-sm md:text-base font-normal px-6 md:px-8 py-2 md:py-2.5 rounded-full mb-6 md:mb-8">
            More than Services
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8 max-w-5xl mx-auto">
          {cards.map((card) => (
            <div
              key={card.id}
              className="bg-gray-50 rounded-[32px] shadow-lg flex flex-col h-auto overflow-hidden"
            >
              ...
              <div className="flex items-end justify-center pb-0 overflow-hidden">
                <img
                  src={card.image}
                  alt={card.title}
                  className="w-full h-auto object-contain max-h-[180px] md:max-h-[200px]"
                />
              </div>
            </div>
          ))}
